...
public class ShadowTests {
	...
	/**
	 * Produce a picture of a sphere and triangle with point light and shade and
	 * moving the triangle
	 */
	@Test
	...
	public void sphereTriangleMove2() {
		scene.geometries.add( //
				new Sphere(60, new Point3D(0, 0, -200)) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)), //
				new Triangle(new Point3D(-45, -25, 0), new Point3D(-25, -45, 0), new Point3D(-43, -43, -4)) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)) //
		);
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-90, -90, 200), new Vector(1, 1, -3)) //
						.setKl(1E-5).setKq(1.5E-7));
	...
	public void sphereTriangleMove3() {
		...
		Render render = new Render(). //
				setImageWriter(new ImageWriter("sphereTriangleLightMove3", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
	...
	public void sphereTriangleMove4() {
		...
		Render render = new Render(). //
				setImageWriter(new ImageWriter("sphereTriangleLightMove4", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
