...
public final class Coordinate {
	...
	/**
	 * overloads the equals method to compare two coordinates
	 * 
	 * @param obj obj of a coordinate
	 */
	@Override
	...
	// Only return the digit (no text) so it can later be printed as a point (x,y,z)
